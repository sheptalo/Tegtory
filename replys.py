...
menu_kb = [
    ...
    [KeyboardButton(text="Помощь"), KeyboardButton(text="Мини игры")],
]
menu_reply = ReplyKeyboardMarkup(resize_keyboard=True, keyboard=menu_kb)

mini_gms = [
    [KeyboardButton(text="Инспекция"), KeyboardButton(text="Биржа")],
...
clan_kb = [
    [
        InlineKeyboardButton(
            text="Лидирующие обьединения", callback_data="clan_leaderboard"
        )
    ],
    [
        InlineKeyboardButton(
            text="Уровень", callback_data="factory_leaderboard"
        ),
    ...
    [
        ...
        InlineKeyboardButton(
            text="Столар", callback_data="stolar_leaderboard"
        ),
    ],
    [InlineKeyboardButton(text="Рейтинг", callback_data="rating_leaderboard")],
    [
        InlineKeyboardButton(
            text="Прошлые сезоны", callback_data="old_leaderboard"
        ),
...
shop_reply = InlineKeyboardMarkup(
    resize_keyboard=True, inline_keyboard=shop_kb
)
...
factory_kb = [
    [
        ...
        InlineKeyboardButton(
            text="Запустить фабрику", callback_data="start_factory"
        ),
    ],
    [
        InlineKeyboardButton(
            text="Улучшение", callback_data="upgrade_factory"
        ),
...
factory_reply = InlineKeyboardMarkup(
    resize_keyboard=True, inline_keyboard=factory_kb
)
...
upgrade_markup = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(
                text="улучшить", callback_data="upgrade_factory_conf"
            )
        ],
        [InlineKeyboardButton(text="Обратно", callback_data="back_factory")],
    ]
...
tax_markup = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(
                text="Оплатить налоги", callback_data="pay_tax"
            )
        ],
        [InlineKeyboardButton(text="Обратно", callback_data="back_factory")],
    ]
...
title_shop_kb = [
    ...
    [
        InlineKeyboardButton(
            text="Один из лучших", callback_data="buy_title:Один_из_лучших"
        )
    ],
    [
        InlineKeyboardButton(text="Эколог", callback_data="buy_title:Эколог"),
        InlineKeyboardButton(
            text="Хранитель", callback_data="buy_title:Хранитель"
        ),
    ],
    [InlineKeyboardButton(text="Обратно", callback_data="back_shop")],
]
...
ecology_kb = [
    [
        InlineKeyboardButton(
            text="Уменьшить выбросы +1 1050", callback_data="ecology:1"
        )
    ],
    [
        InlineKeyboardButton(
            text="покупка фильтров +2 2050", callback_data="ecology:2"
        ),
    ],
    [
        InlineKeyboardButton(
            text="рециркуляции воды +5 5050", callback_data="ecology:5"
        )
    ],
    [
        InlineKeyboardButton(
            text="энергоэффективные технологии +10 10050",
            callback_data="ecology:10",
        )
    ],
    [InlineKeyboardButton(text="Обратно", callback_data="back_factory")],
]
...
back_factory = InlineKeyboardMarkup(
    inline_keyboard=[
        [InlineKeyboardButton(text="Обратно", callback_data="back_factory")]
    ]
)

create_factory_markup = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(
                text="Создать фабрику", callback_data="create_factory"
            )
        ]
    ]
)
