...
welcome = 'Добро пожаловать! Воспользуйся /create_factory чтобы создать свою фабрику.'
...
⚔️ *Битва фабрик:*
Сражайся в чатах против других игроков и получай рейтинг за то что прокачал фабрику.
